...
class ParserModel(nn.Module):
    ...
    def embedding_lookup(self, t):
        ...
        pre_emb = self.pretrained_embeddings(t)
        x = pre_emb.view(batch_size, -1)
    ...
    def forward(self, t):
        ...
        # print(t.shape)
        hidden = self.embed_to_hidden(self.embedding_lookup(t))
        # print(hidden.shape)
        drop_out = self.dropout(self.relu(hidden))
